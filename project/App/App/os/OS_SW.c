...
// See Main01.h for details of error codes
...
/*------------------------------------------------------------------*-
  ...
  REPEAT - If 'REPEAT' is 0, the function is only called once,
           at the time determined by 'DELAY'.  If REPEAT is non-zero,
           then the function is called repeatedly at an interval
           determined by the value of REPEAT (see below for examples
...
//      LED_pin = 1;
      ...
      //PORTB_BIT0=~ PORTB_BIT0;;//LED TEST
      //val=LED_GetVal();
      //val=!val;
