...
#define W25X16_CMD_WR_EN		(0x06)//Ð´Ê¹ÄÜÖ¸Áî
#define W25X16_CMD_WR_DIS		(0x07)//Ð´½ûÄÜÖ¸Áî
#define W25X16_CMD_RD_STS		(0x05)//¶Á×´Ì¬¼Ä´æÆ÷
#define W25X16_CMD_WR_STS		(0x01)//Ð´×´Ì¬¼Ä´æÆ÷
#define W25X16_CMD_RD_DAT		(0x03)//¶ÁÈ¡Êý¾Ý
#define W25X16_CMD_FR_DAT		(0x0B)//¿ìËÙ¶ÁÈ¡
#define W25X16_CMD_WR_DAT		(0x02)//Ò³±à³Ì
#define W25X16_CMD_ER_SEC		(0x20)//²Á³ýsector
#define W25X16_CMD_ER_BLK		(0xD8)//²Á³ýblock
#define W25X16_CMD_ER_CHP		(0xC7)//ÕûÆ¬²Á³ý
...
extern uint16_t		g_flashWrRdTime;//¶ÁÈ¡Ð´Èë¼ÆÊ±
