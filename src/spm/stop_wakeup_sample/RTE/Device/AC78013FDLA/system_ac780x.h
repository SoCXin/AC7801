...
#define PLL_PREDIV   PLL_PREDIV_1      /*!< pll vco = (XTAL_FREQ * PLL_FBKDIV) / PLL_PREDIV */

#define SYSCLK_DIV   SYSCLK_DIVIDER_1  /*!< sysclk = vco / (PLL_POSDIV * SYSCLK_DIV) */
#define SYSCLK_FREQ  48000000UL
#define APBCLK_DIV   APBCLK_DIVIDER_2  /*!< apbclk = sysclk / APBCLK_DIV */
